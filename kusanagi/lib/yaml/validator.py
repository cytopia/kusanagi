...
def _validate_invalid_keys(section: str, data: Dict[Any, Any], validator: Dict[Any, Any]) -> None:
    for key in data:
...
def _validate_requirements(section: str, data: Dict[Any, Any], validator: Dict[Any, Any]) -> None:
    ...
    for key in validator:
        ...
        if key in data and not isinstance(data[key], validator[key]["type"]):
            ...
            raise KeyError(f"[CONFIG-FAIL] {section}[{key}] must be of type: {req_type}")
